...
const isAuditForbid = (flowType: FlowType) => flowType === FlowType.OTHER;
            ...
            <Container>
                ...
                >
                    <Checkbox
                        ...
                        onChange={handleChange}
                        disabled={isAuditForbid(values.flowType)}
                    >
